...
namespace IDC.AggrMapping.Controllers
{
    ...
    [ApiController]
    public partial class AggregationConfig(SystemLogging systemLogging, PostgreHelper pgHelper)
        : ControllerBase
    {
        ...
        )
        {
            try
            {
                return new APIResponseData<object?>().ChangeData(
                    data: await dataPostgre.GetAllDataVersion()
                );
            }
            catch (Exception ex)
            {
        ...
        )
        {
            ...
            {
                return new APIResponseData<object?>().ChangeData(
                    data: await dataPostgre.GetAllDataActive()
                );
            }
            catch (Exception ex)
            {
